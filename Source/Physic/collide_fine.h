...
namespace cyclone {
     ...
     */
	class CollisionPrimitive : public Collision
    {
    public:
        /**
    ...
    public:
		...
		static bool boxAndRay(Ray & ray,  CollisionBox &one, CollisionBox &two);
		static bool ShpereAndRay(Ray & ray,  CollisionBox &one, CollisionSphere &two);
    };
